...
plt.tight_layout()
fig.savefig("Figures/" + "CH4_C2H6_Surface_10%Components_R500_standard_atmosphere2" + ".png", dpi=300)
...
plt.tight_layout()
fig.savefig("Figures/" + "CH4_C2H6_Surface_10%Components_R500_difference_standard_atmosphere2" + ".png", dpi=300)
